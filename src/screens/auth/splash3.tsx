...
type Props = NativeStackScreenProps<StackAuth,'Splash3'>

const onPressSkip = () => { }

const Splash3 = ({navigation}:Props) => {
    const onPressPrev = () => { navigation.navigate("Splash2")}
    const onPressNext = () => {navigation.navigate("SignIn") }
    return (
        <View style={styles.container}>
            <View style={styles.top}>
                <Text style={styles.txtTop}>3/3</Text>
            ...
            <View style={styles.img}>
                ...
                <Text style={styles.txtTitle}>Get Your Order</Text>
